...
public class OvertimeSnapshotTask implements Runnable {

	private static final Logger logger = LoggerFactory.getLogger(OvertimeSnapshotTask.class);
	
	private String name;
	private WebApplicationContext springContext;
	
	public OvertimeSnapshotTask(String name, WebApplicationContext springContext) {
		this.name = name;
